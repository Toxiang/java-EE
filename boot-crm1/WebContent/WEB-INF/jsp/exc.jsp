...
<% request.setCharacterEncoding("UTF-8"); %>
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">职工其他信息系统 v2.0</a>
		</div>
		<!-- /.navbar-header -->
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">职工其他信息</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/customer/exc.action" method="get">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<itcast:page url="${pageContext.request.contextPath }/customer/exc.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
